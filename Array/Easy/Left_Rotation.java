...
class Main {
    public static void main(String[] args) {
        ...
        for(int i=0 ; i<arr.length-1; i++){
            arr[i] = arr[i+1];
            // bringing the elements one place aage khud k index k
            
        }
        arr[size - 1] = temp; 
        //jo index 0 ka elemnt hai woh aayega last index pe
        System.out.println("sorted array after the left once");
